...
After careful selection, 8 columns are left in the data. Below is a table of the variable names.
...
We have one week of tweet data from 10.28 to 11.03. From combining these data set, we have a total of 484678 of data.
