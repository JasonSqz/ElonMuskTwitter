...
```
It is very interesting that "rocket" appears to be the most frequent emoji. We are unsure if it is responding to the spaceX project, or if it is expectation on crypto-currceny: "To the moon `r emo::ji("rocket")`". 
